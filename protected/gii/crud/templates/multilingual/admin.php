...
<h1><?php echo '<?php'; ?> echo Yii::t('app','manage')." ".Yii::t('app','<?php echo $label; ?>',0); <?php echo '?>'; ?></h1>


<p>
<?php echo "<?php echo Yii::t('app','comparisonSearch'); ?>" ?>
</p>

<?php echo "<?php echo CHtml::link(Yii::t('app','advancedSearch'),'#',array('class'=>'search-button')); ?>"; ?>
