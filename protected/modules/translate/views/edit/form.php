...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="row">
        ...
        <?php echo $form->textField($model->source,'message',array('disabled'=>'disabled','class'=>'span8')); ?>
    </div>
    
	<div class="row">
		<?php echo $form->labelEx($model,'translation'); ?>
		<?php echo $form->textArea($model,'translation',array('class'=>'span8')); ?>
	...
	<?php Yii::app()->clientScript->registerScript('focus', 'jQuery("#Message_translation").focus();',CClientScript::POS_READY); ?>
<?php $this->endWidget(); ?>
