...
class Message extends CActiveRecord{
	...
	function rules(){
		return array(
			...
			array('translation', 'secure'),
			array('id, language, translation, category, message', 'safe', 'on'=>'search'),
		);
	}
	
	public function secure($attribute,$params){
		$this->translation=str_replace('script', '', str_replace('<script>', '', str_replace('</script>', '', $this->translation)));
	}
