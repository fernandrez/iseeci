...
class EditController extends TranslateBaseController
{
	...
	public function actionCreate($id,$language)
	{
        ...
        $model->translation=ucfirst($model->source->message);
		$model->translation=str_replace('vision','visión',$model->translation);
		$model->translation=str_replace(' dia ',' día ',$model->translation);
		$model->translation=str_replace('cion ','ción ',$model->translation);
		$model->translation=str_replace('vision','visión',$model->translation);
		$model->translation=str_replace(' esten ',' estén ',$model->translation);
		$model->translation=str_replace('accion','acción',$model->translation);
		$model->translation=str_replace('electrovalvula','electroválvula',$model->translation);
